                        ...
                        <div className='flex justify-center items-center mt-5 mb-5 w-2xs'>
                            <button
                                className={theme === 'light'
                                    ? 'bg-[#A3E1EC] px-6 py-2 rounded-full text-sm border-2 border-[#A3E1EC] cursor-pointer hover:border-blue-500'
                                    : 'bg-[#E3F3FB] px-6 py-2 rounded-full text-sm border-2 text-black hover:border-blue-500'}
                                type="button">
                                Sign In with Google
                            </button>
                        </div>
