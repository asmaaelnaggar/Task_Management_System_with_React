                            ...
                            <form onSubmit={handleSubmit} action="/submit" className='flex flex-col gap-8'>
                                <div className='flex flex-col gap-2'>
                                    ...
                                    <div className='flex gap-4 justify-center items-center mt-5 mb-5'>
                                        <p>Remember the password?<a className={theme === 'light' ? 'text-[#212121] underline underline-offset-1' : 'text-white underline underline-offset-1'} href="/login">Log in</a></p>
                                    </div>
                                </div>
