...
const SideBarResponsive = () => {
  ...
  return (
    <div className={theme=="light"? 'bg-white flex flex-col gap-[30px] w-[200px] h-[250px] rounded-[20px] py-[30px] absolute  z-1000':'flex flex-col gap-[30px] w-[200px] h-[250px] rounded-[20px] py-[30px] absolute bg-black z-1000'}>
