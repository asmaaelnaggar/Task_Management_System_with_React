...
const WelcomeTaskManager = () => {
  ...
  return (
    <div className={theme == 'light' ? "bg-white rounded-3xl shadow-md flex flex-col md:flex-row items-center w-full max-w-5xl p-4 md:p-6 pt-2 md:pt-4" : "bg-gray-900 rounded-3xl shadow-md flex flex-col md:flex-row items-center w-full max-w-5xl p-4 md:p-6 pt-2 md:pt-4"}>
